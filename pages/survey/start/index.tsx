    ...
    <Layout title="Start Survey">
      <div className={`${style["start_survey_container"]}`}>
        <div>
          ...
          >
            <span>About you ―</span> <br className="d-none d-sm-block" /> Tell
            us about <br className="d-none d-sm-block" /> your work style
          </h1>
          ...
          <p className={`${style.subtitle} f22 text-white`}>
            Answer the following questions to set up your profile.{" "}
            <br className="d-none d-sm-block" /> It should take a few minutes to
            complete.
          </p>
